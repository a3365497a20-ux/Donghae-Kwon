...
<%
    ...
    if("POST".equals(request.getMethod())){
        ...
        if(cancelId!=null&&!cancelId.trim().isEmpty()){
            try{
                ...
                int n=ps.executeUpdate();ps.close();cc.close();
                cancelMsg=n>0?"예약이 취소되었습니다.":"취소할 수 없는 예약입니다.";
    ...
    try{
        ...
        PreparedStatement ps=conn.prepareStatement(
            "SELECT r.reserve_id,r.asset_no,IFNULL(a.item_name,'강의실') AS item_name,"+
  ...
  <div>
    ...
    <div class="card">
      <div class="card-head">
        ...
        <div><div class="ch-title">강의실 · 공간 예약</div><div class="ch-sub">원하는 공간을 선택하세요</div></div>
      </div>
      <div class="card-body">
        <div class="cat-grid">
